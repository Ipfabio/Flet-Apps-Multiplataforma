...
def main(page: ft.Page):
    """
    Configura una página con barras de desplazamiento personalizadas y varios botones para desplazarse
    y ajustar la vista de la columna.
    """
    page.theme = ft.Theme(
    ...
    # Configuración del tema de la barra de desplazamiento
    cl = ft.Column(
        spacing=10,
        height=200,
        width=float("inf"),
    ...
    # Bucle para agregar contenido inicial a la columna
    ...
    # Definición de funciones para desplazamiento y botones  
    page.add(
